...
awful.screen.connect_for_each_screen(function(s)
	...
	-- widgets
	--~~~~~~~~
	local profile = require("widgets.menubar.mods.cc.profile")
	local sliders = require("widgets.menubar.mods.cc.sliders_2")
	local utils = require("widgets.menubar.mods.cc.utils")
	local song = require("widgets.menubar.mods.cc.music")
	...
	cc_toggle = function(screen)
		...
		if not control_c.visible then
			control_c.x = s.geometry.width - (control_c.width + 26)
