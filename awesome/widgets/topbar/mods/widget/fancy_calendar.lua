...
local function daywidget(day, weekend)
	return wibox.widget({
		markup = weekend and helpers.colorize_text(day, beautiful.fg_color) or day,
		align = "center",
...
local function currwidget(day)
	return wibox.widget({
		...
		shape = helpers.rrect(6), -- Rounded corners
...
local prev_button = wibox.widget({
	...
	font = beautiful.icon_var .. "Bold 18",
	widget = wibox.widget.textbox,
...
return function(s)
	...
	calendar:setup({
		...
		widget = wibox.container.margin,
		margins = { top = 8, left = 0, bottom = 5, right = 0 },
	})
